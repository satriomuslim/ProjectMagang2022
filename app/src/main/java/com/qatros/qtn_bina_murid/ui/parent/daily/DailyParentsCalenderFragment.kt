 ...
 * Use the [DailyParentsCalenderFragment.newInstance] factory method to
...
class DailyParentsCalenderFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DailyParentsCalenderFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DailyParentsCalenderFragment().apply {

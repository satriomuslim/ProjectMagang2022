 ...
 * Use the [DailyReportChildPedagogueFragment.newInstance] factory method to
...
class DailyReportChildPedagogueFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DailyReportChildPedagogueFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DailyReportChildPedagogueFragment().apply {
